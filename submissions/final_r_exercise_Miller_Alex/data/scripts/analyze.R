...
merged <- read_csv("~/Desktop/Capstone/data/processed/merged.csv")
...
write_csv(county_summary, "~/Desktop/Capstone/data/processed/county_summary.csv")
write_csv(top_bottom_scores, "~/Desktop/Capstone/data/processed/top_bottom_poverty_scores.csv")
write_csv(poverty_group_trend, "~/Desktop/Capstone/data/processed/poverty_group_trend.csv")
write_csv(score_range_by_year, "~/Desktop/Capstone/data/processed/score_range_by_year.csv")
